    ...
    <div className="w-[85%] bg-gray-100 px-4 py-2 lg:h-screen flex">
      <div className="flex-wrap mx-auto my-auto w-[94%] bg-white h-[90%] rounded-xl border-2 border-blue-100">
        ...
        <div className=" flex w-[100%] p-4 space-x-4 text-sm font-poppins">
          <div className="w-[23%] h-32 mt-2 font-bold border-1 rounded-md bg-purple-100 ">
            <h1 className="mt-2 px-4 pt-2 text-left ">Total Task</h1>
          ...
          <div className="mt-2 w-[25%] font-bold border-1 rounded-md bg-sky-100 h-28">
          ...
          <div className="w-[25%] mt-2 font-bold border-1 rounded-md bg-orange-100 h-28">
          ...
          <div className="w-[25%] mt-2 font-bold border-1 rounded-md bg-green-100 h-28">
